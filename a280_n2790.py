...
def nsga2_with_aco(items, nodes, capacity, generations, population_size, mutation_rate=0.1, crossover_rate=0.7):
  ...
  # Non-dominated sorting and crowding distance calculation
        ...
        population = unique_population[:100]
...
capacity = 1262022
final_population = nsga2_with_aco(items, nodes, population_size=200, generations=1000, mutation_rate=1, crossover_rate=1, capacity=capacity)
