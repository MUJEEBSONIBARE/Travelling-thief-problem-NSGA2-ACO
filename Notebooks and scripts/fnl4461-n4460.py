...
def nsga2_with_aco(items, nodes, capacity, generations, population_size, mutation_rate=0.1, crossover_rate=0.7):
    ...
    for generation in range(generations):
        ...
        population = unique_population[:50]
...
capacity = 387150
final_population = nsga2_with_aco(items, nodes, population_size=5, generations=1000, mutation_rate=1, crossover_rate=1, capacity=capacity)
